              ...
              try {
                ...
                if(status === "true" && last_reset < (time_current)){ 
                    ...
                    const payload = {
                        ...
                        const result = queue.receive(groupKey, payload, async (symb, meta) => {
                ...
                console.error(`[ScanTimeOpen] Error processing time entry for ${sym}:`, err.message);
              }
            });
          } catch (err) {
            console.error(`[ScanTimeOpen] Error fetching symbol info for ${sym}:`, err.message);
            return;
          }
        });
